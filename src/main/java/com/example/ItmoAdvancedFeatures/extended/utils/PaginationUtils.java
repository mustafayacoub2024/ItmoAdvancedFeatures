package com.example.ItmoAdvancedFeatures.extended.utils;
...
public class PaginationUtils {
    public static Pageable getPageRuquest(Integer page, Integer perPage, String sort, Sort.Direction order) {
        if (page == null) {
            page = 0;
        } else if (page > 0) {
            page = page - 1;
